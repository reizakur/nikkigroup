...
import 'package:nikki_flutter/screen/models/models_barang_rusak.dart';
...
class _HalamanRejectState extends State<HalamanReject> {
  File? _image;
  ...
  void fetchProdukRusak() async {
    ...
    final responseku = await http.post(
        'https://nikkigroup.joeloecs.com/mobileapi/fetch_barang_rusak.php',
        body: {
          "res_id": 'nothing',
        });
    ...
    if (data[0]['result'] == '1') {
      ...
      for (int i = 0; i < count; i++) {
        RusakModel.rusaklist.add(RusakModel.fromjson(data[1][i]));
      }
      print('check length ${RusakModel.rusaklist.length}');
    } else {
      print('NO DATA');
    }
    setState(() {});
  ...
  void deleteBarangRusak(id_barang_rusak) async {
    RusakModel.rusaklist.clear();
    final responseku = await http.post(
        'https://nikkigroup.joeloecs.com/mobileapi/delete_rusak.php',
        body: {
                    ...
                    rows: RusakModel.rusaklist
                        .map((data) => DataRow(cells: [
                              DataCell(Container(
                                ...
                                //  color: Colors.blue,
                                child: AutoSizeText(
                                    '${data.nama_barang} || ${data.qty} || ${data.harga} ||'),
                              )),
                              DataCell(Row(
                                children: [
                                  Container(
                                    ...
                                    child: FlatButton(
                                      ...
                                      onPressed: () {
                                        deleteBarangRusak(data.id_barang_rusak);
                                      },
                                    ),
                                  ),
                                ],
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                            ...
                            onPressed: () {
                              launch(
                                  'https://nikkigroup.joeloecs.com/admin/cetak_barang_rusak.php');
                            },
                          ...
                          child: CupertinoButton(
                            ...
                            onPressed: () async {
                              ...
                              var response = await dio.post(
                                  'https://joeloecs.com/bersama/nikki/mobileapi/tambah_barang_rusak.php',
                                  data: formData);
                              print(
