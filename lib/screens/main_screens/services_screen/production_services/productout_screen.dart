...
class ProductOutScreen extends StatelessWidget {
  const ProductOutScreen({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InputOutputPage(
        titleRole: 'Product Out',
  ...
  void submitButton() async {
    ...
    PendingInOut newData = PendingInOut.insert(
      colActionType: 'out',
