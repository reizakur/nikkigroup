...
class ProductQCBranch extends StatefulWidget {
  @override
  _ProductQCBranchState createState() => _ProductQCBranchState();
}

class _ProductQCBranchState extends State<ProductQCBranch> {
...
// for a file
    ...
    PendingProductQCBranch newData = new PendingProductQCBranch.insert(
        colActionType: 'ProductQCBranch',
        colSubmitTime: now,
